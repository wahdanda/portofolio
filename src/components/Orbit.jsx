...
export default function OrbitImages({
  ...
  // ✅ Memperbaiki Forced Reflow menggunakan ResizeObserver Entry (tanpa membaca layout geometri langsung)
  useLayoutEffect(() => {
  ...
  return (
    <div
      ...
      style={{
        ...
        maxWidth: responsive ? '820px' : width,
        height: responsive ? '820px' : height,
      }}
    >
      <div
        ...
        style={{
          ...
          visibility: responsive && scale === null ? 'hidden' : 'visible',
        }}
      >
        <div
