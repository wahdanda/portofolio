    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto">
                <p className="text-emerald-500 font-semibold uppercase tracking-widest mb-2 text-sm">
                    Contact
                </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 font-semibold text-gray-200">
                                <Icon icon="line-md:email" className="text-2xl text-emerald-500" aria-hidden="true" />
                                <span>Email</span>
                            </div>
                            <a
                                href="mailto:gstngrdandahasta@gmail.com"
                                className="text-gray-400 hover:text-emerald-400 break-all transition-colors block text-sm"
                            >
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 font-semibold text-gray-200">
                                <Icon icon="line-md:map-marker" className="text-2xl text-emerald-500" aria-hidden="true" />
                                <span>Location</span>
                            </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 font-semibold text-gray-200">
                                <Icon icon="line-md:github" className="text-2xl text-emerald-500" aria-hidden="true" />
                                <span>GitHub</span>
                            </div>
                            <a
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 font-semibold text-gray-200">
                                <Icon icon="line-md:linkedin" className="text-2xl text-emerald-500" aria-hidden="true" />
                                <span>LinkedIn</span>
                            </div>
                            <a
                ...
                <div className="border-t border-white/10 mt-14 pt-8 flex flex-col md:flex-row justify-between items-center gap-5">
                    ...
                    <button
                        ...
                        className="w-12 h-12 rounded-xl border border-white/10 hover:border-emerald-500 hover:bg-emerald-600 transition-all flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-emerald-400"
                    >
